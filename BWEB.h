...
namespace BWEB
{
	...
	private:
		...
		bool iteratePieces(vector<UnitType>& buildings, const BWEM::Area *, const BWEM::ChokePoint *, UnitType);
		bool testPiece(TilePosition, vector<UnitType>& buildings, const BWEM::Area *, const BWEM::ChokePoint *, UnitType);
		bool placePiece(TilePosition, vector<UnitType>& buildings, const BWEM::Area *, const BWEM::ChokePoint *, UnitType);
